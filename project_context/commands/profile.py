...
#         email = profile_data.email or "Sin autenticar"
#         secret = profile_data.associated_secret or "Sin asociar"
...
#         creds = AuthService.run_oauth_flow(selected_secret_path)
#         email = AuthService.fetch_user_email(creds)
...
#     profile_data = profile_manager.load_profile_data(name)

#     email = profile_data.email
#     secret_name = profile_data.associated_secret
...
#     if profile_data.secret_path.exists():
